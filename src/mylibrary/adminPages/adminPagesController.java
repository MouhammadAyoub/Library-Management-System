...
public class adminPagesController implements Initializable {
    ...
    @FXML
    private AnchorPane AnchorPane_adminHome;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            if (AnchorPane_adminHome != null) {
                AnchorPane_adminHome.setBackground(background);
            }
        } catch (Exception e) {
            System.out.print(e);
        }
