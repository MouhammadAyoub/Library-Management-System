...
public class memberPagesController implements Initializable {
    ...
    @FXML
    private AnchorPane AnchorPane_memberHome;
    ...
    private void getReservationsList(ActionEvent event) throws SQLException {
        ...
        phone = clientPhoneReservations.getText();
        ResultSet res = db.SelectFun("select RESERVATION_ID,BOOK_TITLE,RESERVATION_DATE from reservation,book where CLIENT_PHONE='" + phone + "' AND book.BOOK_ID=reservation.BOOK_ID ; ");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            if (AnchorPane_memberHome != null) {
                AnchorPane_memberHome.setBackground(background);
            }
        } catch (Exception e) {
            System.out.print(e);
        }
